...
public class CalendarProvider extends ContentProvider {
	...
	private static final String  AUTHORITY = "com.tyczj.extendedcalendarview.mycalendar";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper{
    	...
    	private void createTables(SQLiteDatabase db){
    		db.execSQL("CREATE TABLE " + EVENTS_TABLE + "(" + ID + " integer primary key autoincrement, " +
    				...
    				+ START + " INTEGER, "+ END + " INTEGER, " + START_DAY + " INTEGER, " + END_DAY + " INTEGER, " + COLOR +" INTEGER," + PHOTO + " BLOB" + ");");
    	}
    }
